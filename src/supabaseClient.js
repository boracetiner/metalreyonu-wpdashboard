...
// Veri sorguları için token'ı manuel ekleyen yardımcı
export function getAuthHeaders() {
  const session = JSON.parse(localStorage.getItem('metalreyonu-auth') || '{}')
...
// Authenticated sorgu için fetch wrapper
